#!/usr/bin/env python
"""
Script to check backend configuration and diagnose the signup issue.
"""
...
def check_environment_variables():
    ...
    if jwt_secret and len(jwt_secret) < 32:
        print(f"⚠️  JWT_SECRET should be at least 32 characters long (current: {len(jwt_secret)})")
...
def main():
    ...
    try:
        ...
        print("\n⚠️  Could not import database modules - might be a deployment issue")
