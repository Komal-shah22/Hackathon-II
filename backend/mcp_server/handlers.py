...
def add_task(input: AddTaskInput, user_id: str, session: Session) -> AddTaskOutput:
    """
...
def list_tasks(input: ListTasksInput, user_id: str, session: Session) -> ListTasksOutput:
    """
...
def complete_task(input: CompleteTaskInput, user_id: str, session: Session) -> CompleteTaskOutput:
    """
...
def delete_task(input: DeleteTaskInput, user_id: str, session: Session) -> DeleteTaskOutput:
    """
...
def update_task(input: UpdateTaskInput, user_id: str, session: Session) -> UpdateTaskOutput:
    """
